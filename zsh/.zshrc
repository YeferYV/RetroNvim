...
[[ "$OSTYPE" == "linux-gnu"    ]] && export PATH="$RETRONVIM_PATH/bin/linux/envs/linux/bin:$HOME/.pixi/bin:$HOME/.local/share/pnpm:$HOME/.local/bin:$RIPGREP_LINUX:$PATH"
...
[[ "$OSTYPE" == "linux-gnu"    ]] && test ! -e ~/.local/share/fonts/FiraCode && mkdir -p ~/.local/share/fonts && cp -r $RETRONVIM_PATH/bin/nerd-fonts/patched-fonts/FiraCode ~/.local/share/fonts/FiraCode && fc-cache
[[ "$OSTYPE" == "darwin"       ]] && test ! -e ~/Library/Fonts/FiraCode      && mkdir -p ~/.local/share/fonts && cp -r $RETRONVIM_PATH/bin/nerd-fonts/patched-fonts/FiraCode ~/Library/Fonts/FiraCode
[[ "$OSTYPE" == "darwin"       ]] && export PATH="$RETRONVIM_PATH/bin/macos/envs/macos/bin:$HOME/.pixi/bin:$HOME/Library/pnpm:$HOME/.local/bin:$RIPGREP_MACOS:$PATH"
...
[[ "$OSTYPE" == "msys"         ]] && export PATH="$PATH:$RETRONVIM_PATH/bin/windows/envs/windows/Library/bin:$HOME/.pixi/bin:$HOME/appdata/local/pnpm:$HOME/.local/bin:$RIPGREP_MSYS2:$PATH"
